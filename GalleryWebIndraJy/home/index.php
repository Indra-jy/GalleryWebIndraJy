...
?>
    ...
    <img src="../assets/img/<?php echo $data['lokasifile']; ?>" class="card-img-top" title="<?php echo $data['judulfoto']; ?>" style="height: 12rem;" alt="">
      ...
      <?php 
        ...
        <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid']; ?>" type="submit" name="batalsuka" style="text-decoration: none;"> 
        <i class="fa fa-heart"></i></a>

        <?php }else{ ?>

        <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid']; ?>" type="submit" name="suka" style="text-decoration: none;"> 
      ...
      ?>
          ...
          <a href="" type="button" class="" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>" style="text-decoration: none;">
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-8">
                <img src="../assets/img/<?php echo $data['lokasifile']; ?>" class="card-img-top" title="<?php echo $data['judulfoto']; ?>"alt="">
                </div>
                <div class="col-md-4">
                  <div class="m-2">
