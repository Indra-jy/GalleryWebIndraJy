                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['albumid']; ?>">
                                            Edit
                                        </button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../config/aksi_album.php" method="POST">
                                                            ...
                                                            <label class="form-label" for="namaalbum">Nama Album</label>
